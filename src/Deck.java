...
public class Deck {
    ...
    private void initializeDeck() {
        ...
        String[] suits = {"Süda", "Ristid", "Poti", "Ärt"};
        String[] values = {"2", "3", "4", "5", "6", "7", "8", "9", "10", "Poiss", "Emand", "Kuningas", "Äss"};
    ...
    public Card dealCard() {
        if (cards.isEmpty()) { // Kontrollimine, kas tekk on tühi.
            throw new IllegalStateException("Tekk on tühi"); // Erandi viskamine, kui tekk on tühi.
        }
